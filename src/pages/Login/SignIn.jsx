    ...
    try {
      ...
      switch (code) {
        case "auth/user-not-found": {
          setErrorCode({
            message: `No existe un usuario con el correo "${data.email}", intentalo nuevamente.`,
          });
          break;
        }
        ...
        case "auth/too-many-requests": {
          setErrorCode({
            message: <>Demaciados intentos, intentalo nuevamente mas tarde</>,
          });
          break;
        }
        case "auth/user-disabled":
          {
            setErrorCode({
              message: <>Su cuenta se encuentra desabilitada</>,
            });
            break;
          }
          break;
          ...
          <Container className=" w-[350px] bg-white :bg-transparent  p-3 flex flex-col gap-2 rounded-lg border">
            ...
            <div className="px-1">
              ...
              <span className="flex text-sm mt-1 text-zinc-500">
                Inicia sesion con tu cuenta de Nueva Acropolis
              </span>
            </div>
            {errorCode && (
              <div className="p-2 bg-red-100 text-red-800  rounded-md border border-red-400 text-sm">
                {errorCode.message}
              </div>
            )}
