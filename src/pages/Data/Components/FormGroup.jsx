...
import {
  deleteDataGroupService,
  saveDataGroupService,
  updateDataGroupService,
...
export default function FormGroup(props) {
  ...
  const onSubmit = async () => {
    ...
    if (props.data) {
      ...
      await updateDataGroupService(newData, props.data.uid);
    } else {
      newData = {
        ...newData,
      ...
      await saveDataGroupService(newData);
    }
    setLoading(false);
    props.close();
  };
  ...
  const handledelete = async () => {
    ...
    if (confirm) {
      setLoading(true);
      await deleteDataGroupService(data.uid);
      setLoading(false);
