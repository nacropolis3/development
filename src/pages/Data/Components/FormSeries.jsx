...
import {
  deleteDataSeriesService,
  saveDataSeriesService,
  updateDataSeriesService,
...
export default function FormSerie(props) {
  ...
  const onSubmit = async () => {
    ...
    if (props.data) {
      ...
      await updateDataSeriesService(newData, props.data.uid);
    } else {
      newData = {
        ...newData,
      ...
      await saveDataSeriesService(newData);
    }
    setLoading(false);
    props.close();
  };
  ...
  const handledelete = async () => {
    ...
    if (confirm) {
      setLoading(true);
      await deleteDataSeriesService(data.uid);
      setLoading(false);
