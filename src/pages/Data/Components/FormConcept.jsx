...
import {
  deleteDataConceptService,
  saveDataConceptService,
  updateDataConceptService,
} from "../../../services/Data/DataServices";

export default function FormConcept(props) {
  ...
  const onSubmit = async () => {
    ...
    if (props.data) {
      ...
      await updateDataConceptService(newData, props.data.uid);
    } else {
      newData = {
        ...newData,
      ...
      await saveDataConceptService(newData);
    }
    setLoading(false);
    props.close();
  };
  ...
  const handledelete = async () => {
    ...
    if (confirm) {
      setLoading(true);
      await deleteDataConceptService(data.uid);
      setLoading(false);
    ...
    <div className=" flex flex-col gap-2 ">
      <div className="flex items-center gap-1">
        ...
        <div className=" font-semibold text-sm dark:text-white flex flex-col">
          ...
          <span className="leading-3 flex  font-normal text-xs text-neutral-500">{TimeAgoDateComplete()}</span>
        </div>
      </div>
