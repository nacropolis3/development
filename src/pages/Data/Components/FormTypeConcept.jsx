...
export default function FormTypeConcept(props) {
  ...
  const onSubmit = async () => {
    ...
    if (props.data) {
      ...
      await updateDataTypeConceptService(newData, props.data.uid);
    } else {
      newData = {
        ...newData,
      ...
      await saveDataTypeConceptService(newData);
    }
    setLoading(false);
    props.close();
  };
  ...
  const handledelete = async () => {
    ...
    if (confirm) {
      setLoading(true);
      await deleteDataTypeConceptService(data.uid);
      setLoading(false);
